...
def get_args():
   ...
   # parser.add_argument('--ckpt_path', type=str, default='root_path/logs/GeoClip/f1dtv48z/checkpoints/step=86750-val_loss=4.100.ckpt')
    ...
    parser.add_argument('--test_data', type=str, default='data_dir/YFCC100m/webdataset/9f248448-1d13-43cb-a336-a7d92bc5359e.tar')
    parser.add_argument('--clipcap_model_path', type=str, default='root_path/pretrained_models/clipcap/conceptual_weights.pt')
    parser.add_argument('--output_path', type=str, default='root_path/logs/evaluations/cvpr/generated_text')
